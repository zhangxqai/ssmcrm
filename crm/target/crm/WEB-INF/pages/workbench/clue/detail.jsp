		...
		<c:forEach items="${clueRemarkList}" var="crl">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style="color: gray;"> ${crl.editFlag == "0"?crl.createTime:crl.editTime}由${crl.editFlag == "0"?crl.createBy:crl.createTime}</small>
